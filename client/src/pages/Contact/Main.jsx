...
const Main = () => {
  ...
  return (
    <div className="flex h-screen relative items-center  ">
      <div
        className="flex phone:max-md:hidden flex-grow h-[100vh] w-full basis-[47%]  "
        style={{
      ...
      <div className=" h-[100vh] w-full basis-[53%] phone:max-md:basis-full flex items-center justify-center">
        <Form />
      </div>
    </div>
  );
