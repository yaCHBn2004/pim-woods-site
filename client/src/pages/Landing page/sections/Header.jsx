...
export const Header = () => {
  return (
    <div className='header'>
      <div className=' text-white md:gap-[1.5rem] phone:max-md:gap-[1.2rem] md:pt-32 phone:max-lg:pt-24 flex flex-col items-center '>
        <h1 className=' text-6xl phone:max-md:text-4xl phone:max-md:w-[65%] font-medium md:w-[50%] xl:w-[40%]'>Artisanat solide intemporel</h1>
